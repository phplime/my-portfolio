...
INSERT INTO `users` (`id`, `username`, `email`, `phone`, `country`, `password`, `gender`, `address`, `blood_group`, `designation`, `website`, `user_type`, `is_active`, `messege`, `login_time`, `post_time`) VALUES (1, 'Admin', 'admin@gmail.com', '', 13, 'e10adc3949ba59abbe56e057f20f883e', 'Male', '', 0, 'Web Developer', '', 1, 1, '', '2019-12-07 15:55:30', '2018-08-07 12:49:55');
